...
CFLAGS := -g -Wall -pthread -iquote.obj/gen -Wno-uninitialized -DNASSERT -O2 $(LINUX_INCLUDES) -Wno-unused-variable
...
$(BINS) $(TEST_BINS): $(LIBBPF)

$(LIBBPF):
	@mkdir -p $(LIBBPF_PATH)
	$(call trace,MAKE,$@,$(MAKE) -C $(LINUX_PATH)/tools/lib/bpf)
